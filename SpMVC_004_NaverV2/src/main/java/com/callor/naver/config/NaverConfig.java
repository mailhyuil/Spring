...
public class NaverConfig {
	...
	public static class HEADER{
		public static String ID = "kKlobr6I6Y5ErRcqNk8T";
		public static String SEC = "qikPt5A4tE";
		
	}
	
	public static final String NAVER_CLIENT_ID = "kKlobr6I6Y5ErRcqNk8T";
	public static final String NAVER_CLIENT_SEC = "qikPt5A4tE"; 
