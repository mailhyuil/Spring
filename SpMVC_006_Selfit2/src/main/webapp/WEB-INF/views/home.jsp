...
<body>
	<div class="main">
		...
		<ol class="begin-list">
		<c:forEach items="${BEGIN.MENU}" var="MENU" >
				<li><a href="${rootPath }/workout/dayset/${MENU.sc_num}">주당 ${MENU.sc_division }</a></li>
		</c:forEach>
		</ol>

		<ol class="middle-list">
		<c:forEach items="${MIDDLE.MENU}" var="MENU" >
				<li><a href="${rootPath }/workout/dayset/${MENU.sc_num}">주당 ${MENU.sc_division }</a></li>
		</c:forEach>
		</ol>

		<ol class="adv-list">
		<c:forEach items="${ADV.MENU}" var="MENU" >
				<li><a href="${rootPath }/workout/dayset/${MENU.sc_num}">주당 ${MENU.sc_division }</a></li>
		</c:forEach>
		</ol>
...
<script src="${rootPath }/static/home.js?123aaaassaaa4aa1aaaaa4223"></script>
</html>