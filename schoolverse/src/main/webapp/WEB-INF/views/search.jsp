...
<script type="text/javascript"
	src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=nanq2sq1z7"
></script>
</head>
	...
	<div class="wrapper">
		...
		<div class="sub-wrapper">
			<c:forEach items="${CLASS }" var="CLASS">
				<div class="classes" data-aca_code="${CLASS.aca_code}"
					data-class_code="${CLASS.class_code}"
					data-expense="${CLASS.class_fee }"
				>
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2e1d9784e6d6ac580791dd4e2c958267&libraries=services"
></script>
<script src="static/js/search.js?123s3223"></script>
<script src="static/js/basket.js?12312s2323"></script>
<script src="static/js/map_search.js?12s33123"></script>
=======
  <meta charset="UTF-8" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      ...
      <div id="nav">
        ...
        <form>
          <div class="search-bar">
            ...
            <input type="text" placeholder="과목" />
    ...
    <div class="put-in">
      ...
      <div class="content">
        ...
        <div class="info">
          ...
          <h2>수강료 : 300,000원</h2>
          <p>
            yy영어학원은 교육 수준의 향상과 교육의 본질적 가치에 가장 큰 의의를 두고, 해외 명문대 진학을 위한 최고의 교육 서비스를 제공하는 학원입니다.
          </p>
        </div>
        <div class="teacher">
          <h2>선생님소개</h2>
